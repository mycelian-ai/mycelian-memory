...
// NewVaultService constructs a VaultService using the provided storage.Store and searchindex.Index.
// If idx is nil, the service will operate without search indexing.

...
// NewMemoryService creates a MemoryService that orchestrates memory-related use cases.
// It initializes the service with the provided storage.Store, searchindex.Index, and emb.EmbeddingProvider.

...
// The returned MemoryService uses the given storage for persistence, the index for optional search-related operations (may be nil), and the embedding provider for generating embeddings.
